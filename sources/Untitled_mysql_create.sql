...
ALTER TABLE `users_details` ADD CONSTRAINT `users_details_fk0` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`);
...
ALTER TABLE `orders` ADD CONSTRAINT `orders_fk2` FOREIGN KEY (`payement_method_id`) REFERENCES `payment_methods`(`id`);
...
ALTER TABLE `players` ADD CONSTRAINT `players_fk0` FOREIGN KEY (`user_details_id`) REFERENCES `users_details`(`id`);

ALTER TABLE `players` ADD CONSTRAINT `players_fk1` FOREIGN KEY (`team_id`) REFERENCES `team`(`id`);

ALTER TABLE `players` ADD CONSTRAINT `players_fk2` FOREIGN KEY (`league_id`) REFERENCES `leagues`(`id`);

ALTER TABLE `players` ADD CONSTRAINT `players_fk3` FOREIGN KEY (`transaction_code`) REFERENCES `orders`(`transaction_code`);
